  ...
  all: [
    {
      ...
      pico: 1,
      top5: [
        { nome: "Dark Horse", semanas: 68, pico: 1 },
        { nome: "Firework", semanas: 61, pico: 2 },
        { nome: "Teenage Dream", semanas: 57, pico: 3 },
        { nome: "California Gurls", semanas: 52, pico: 4 }
      ]
    },
    {
      tipo: "top10",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 38, pico: 1 },
        { nome: "Firework", semanas: 34, pico: 2 },
        { nome: "Teenage Dream", semanas: 29, pico: 3 },
        { nome: "California Gurls", semanas: 25, pico: 4 }
      ]
    },
    {
      tipo: "top5",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 23, pico: 1 },
        { nome: "Dark Horse", semanas: 20, pico: 2 },
        { nome: "Teenage Dream", semanas: 17, pico: 3 },
        { nome: "California Gurls", semanas: 15, pico: 4 }
      ]
    },
    {
      tipo: "topo",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 12, pico: 1 },
        { nome: "Dark Horse", semanas: 10, pico: 1 },
        { nome: "Firework", semanas: 8, pico: 1 },
        { nome: "California Gurls", semanas: 6, pico: 1 }
      ]
    }
  ],
  ...
  "12m": [
    {
      ...
      pico: 1,
      top5: [
        { nome: "Dark Horse", semanas: 44, pico: 1 },
        { nome: "Firework", semanas: 39, pico: 2 },
        { nome: "Teenage Dream", semanas: 36, pico: 3 },
        { nome: "California Gurls", semanas: 31, pico: 4 }
      ]
    },
    {
      tipo: "top10",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 31, pico: 1 },
        { nome: "Firework", semanas: 27, pico: 2 },
        { nome: "Teenage Dream", semanas: 24, pico: 3 },
        { nome: "California Gurls", semanas: 21, pico: 4 }
      ]
    },
    {
      tipo: "top5",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 20, pico: 1 },
        { nome: "Dark Horse", semanas: 18, pico: 2 },
        { nome: "Teenage Dream", semanas: 15, pico: 3 },
        { nome: "California Gurls", semanas: 13, pico: 4 }
      ]
    },
    {
      tipo: "topo",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 10, pico: 1 },
        { nome: "Dark Horse", semanas: 8, pico: 1 },
        { nome: "Firework", semanas: 6, pico: 1 },
        { nome: "California Gurls", semanas: 4, pico: 1 }
      ]
    }
  ],
  ...
  "6m": [
    {
      ...
      pico: 1,
      top5: [
        { nome: "Dark Horse", semanas: 23, pico: 1 },
        { nome: "Firework", semanas: 21, pico: 2 },
        { nome: "Teenage Dream", semanas: 19, pico: 3 },
        { nome: "California Gurls", semanas: 17, pico: 4 }
      ]
    },
    {
      tipo: "top10",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 18, pico: 1 },
        { nome: "Firework", semanas: 16, pico: 2 },
        { nome: "Teenage Dream", semanas: 14, pico: 3 },
        { nome: "California Gurls", semanas: 12, pico: 4 }
      ]
    },
    {
      tipo: "top5",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 13, pico: 1 },
        { nome: "Dark Horse", semanas: 11, pico: 2 },
        { nome: "Teenage Dream", semanas: 9, pico: 3 },
        { nome: "California Gurls", semanas: 7, pico: 4 }
      ]
    },
    {
      tipo: "topo",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 7, pico: 1 },
        { nome: "Dark Horse", semanas: 6, pico: 1 },
        { nome: "Firework", semanas: 5, pico: 1 },
        { nome: "California Gurls", semanas: 4, pico: 1 }
      ]
    }
  ],
  ...
  "3m": [
    {
      ...
      pico: 1,
      top5: [
        { nome: "Dark Horse", semanas: 11, pico: 1 },
        { nome: "Firework", semanas: 10, pico: 2 },
        { nome: "Teenage Dream", semanas: 9, pico: 3 },
        { nome: "California Gurls", semanas: 8, pico: 4 }
      ]
    },
    {
      tipo: "top10",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 9, pico: 1 },
        { nome: "Firework", semanas: 8, pico: 2 },
        { nome: "Teenage Dream", semanas: 7, pico: 3 },
        { nome: "California Gurls", semanas: 6, pico: 4 }
      ]
    },
    {
      tipo: "top5",
      ...
      top5: [
        { nome: "Roar", semanas: 7, pico: 1 },
        { nome: "Dark Horse", semanas: 6, pico: 2 },
        { nome: "Teenage Dream", semanas: 5, pico: 3 },
        { nome: "California Gurls", semanas: 4, pico: 4 }
      ]
    },
    {
      tipo: "topo",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 5, pico: 1 },
        { nome: "Dark Horse", semanas: 4, pico: 1 },
        { nome: "Firework", semanas: 3, pico: 1 },
        { nome: "California Gurls", semanas: 2, pico: 1 }
      ]
    }
  ],
  ...
  "1m": [
    {
      ...
      top5: [
        { nome: "Dark Horse", semanas: 4, pico: 1 },
        { nome: "Firework", semanas: 3, pico: 2 },
        { nome: "Teenage Dream", semanas: 3, pico: 3 },
        { nome: "California Gurls", semanas: 2, pico: 4 }
      ]
    },
    {
      tipo: "top10",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 3, pico: 1 },
        { nome: "Firework", semanas: 3, pico: 2 },
        { nome: "Teenage Dream", semanas: 2, pico: 3 },
        { nome: "California Gurls", semanas: 2, pico: 4 }
      ]
    },
    {
      ...
      top5: [
        { nome: "Roar", semanas: 3, pico: 1 },
        { nome: "Dark Horse", semanas: 2, pico: 2 },
        { nome: "Teenage Dream", semanas: 2, pico: 3 },
        { nome: "California Gurls", semanas: 1, pico: 4 }
      ]
    },
    {
      tipo: "topo",
      ...
      pico: 1,
      top5: [
        { nome: "Roar", semanas: 2, pico: 1 },
        { nome: "Dark Horse", semanas: 2, pico: 1 },
        { nome: "Firework", semanas: 1, pico: 1 },
        { nome: "California Gurls", semanas: 1, pico: 1 }
      ]
    }
  ]
};

function criarItemSequencia(item) {
  return `
    <div class="sequencia-item">
      <div class="sequencia-item-info">
        <div class="sequencia-item-nome">${item.nome}</div>
        <div class="sequencia-item-pico">pico #${item.pico}</div>
      </div>

      <div class="sequencia-item-semanas">
...
function criarCardSequencia(dados) {
  const top5 = dados.top5
    .map((item) => criarItemSequencia(item))
    .join("");

  return `
    <article
      class="sequencia-card"
      data-tipo="${dados.tipo}"
      data-spotify-track-id="${dados.spotifyTrackId}">

      <div class="sequencia-destaque">

        <a
          class="sequencia-capa"
          href="#"
          target="_blank"
          rel="noopener">

          <img
            class="sequencia-imagem imagem-fluida"
            src=""
            alt=""
            loading="lazy">

          <div class="sequencia-placeholder">
            Capa
          </div>

          <div class="sequencia-overlay">
            <i
        ...
        <div class="sequencia-info">
          ...
          <div class="sequencia-chamada"></div>

          <a
            class="sequencia-nome"
            href="#"
            target="_blank"
            rel="noopener">
            ${dados.nome}
          ...
          <div class="sequencia-stats">
            <span>
              <strong>${dados.semanas}</strong> semanas
            </span>

            <span>
              pico <strong>#${dados.pico}</strong>
            </span>
          </div>
      ...
      <div class="sequencia-top5">
        <div class="sequencia-top5-titulo">
          Top 5
        </div>
...
function renderizarSequencias() {
  Object.entries(DADOS_SEQUENCIAS).forEach(
    ([periodo, cards]) => {
      const grade = document.querySelector(
        `.sequencias-periodo[data-periodo="${periodo}"] .grade-sequencias`
      );

      if (!grade) return;

      grade.innerHTML = cards
        .map((dados) => criarCardSequencia(dados))
        .join("");
    }
  );
}

function aplicarCapasSequencias(musicas) {
  const cards = Array.from(
    document.querySelectorAll(
      ".sequencia-card[data-spotify-track-id]"
    )
  );
  ...
  cards.forEach((card) => {
    ...
    const imagem = card.querySelector(".sequencia-imagem");
    const capa = card.querySelector(".sequencia-capa");
    const nome = card.querySelector(".sequencia-nome");

    if (capa) {
      capa.href = musica.spotify || "#";
    }

    if (nome) {
      nome.href = musica.spotify || "#";
    }
    ...
    if (imagem && musica.image) {
      ...
      card.classList.add("sequencia-card-com-imagem");
    }
  });
}
